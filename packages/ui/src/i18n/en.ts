export const dict: Record<string, string> = {
  ...
  // Tool labels are present-continuous so the running state reads as work
  // in progress to non-developer users — "Reading X" not "Read X". The
  // BasicTool component wraps these in TextShimmer for the running state,
  // so the verb-ing form lands naturally as the agent works.
  "ui.tool.read": "Reading",
  "ui.tool.loaded": "Loaded",
  "ui.tool.list": "Looking through",
  "ui.tool.glob": "Finding",
  "ui.tool.grep": "Searching for",
  "ui.tool.task": "Delegating",
  "ui.tool.webfetch": "Fetching",
  "ui.tool.websearch": "Searching the web for",
  "ui.tool.shell": "Running",
  "ui.tool.patch": "Editing",
  "ui.tool.todos": "Planning",
  "ui.tool.todos.read": "Reviewing the plan",
  "ui.tool.questions": "Asking",
  "ui.tool.agent": "{{type}} agent working",
  "ui.tool.agent.default": "Agent working",
